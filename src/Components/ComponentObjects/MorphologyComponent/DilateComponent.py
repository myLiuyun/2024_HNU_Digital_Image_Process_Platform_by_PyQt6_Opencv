...
class DilateComponent(MorphologyComponent):
    name = 'DilateComponent'
    detail = "膨胀操作, kernel_size=5"
    ...
    def processImage(self, image: np.array) -> np.ndarray:
        ...
        ans = super().dilate(binary, kernel_size=5, iterations=1)
